      ...
      >
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <div className="min-w-0">
            <h1 className="text-xl md:text-3xl font-black text-foreground leading-tight">{t('privacy_title')}</h1>
            <p className="text-xs md:text-sm text-muted-foreground">{t('privacy_updated')}</p>
          </div>
        </div>
      </motion.div>
